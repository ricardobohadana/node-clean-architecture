...
import { InvalidTransactionAmountError } from '@/domain/application/errors/invalid-transaction-amount.error'
import { InvalidTransactionDateError } from '@/domain/application/errors/invalid-transaction-date.error'
...
import { NotEnoughStockError } from '@/domain/application/errors/not-enough-stock.error'
